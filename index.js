...
function checkemail(email)
{
    if(email.length > 8 && email.includes('@') )
    {
        ...
        document.getElementById('email_error').innerText="Email must include @, 8 letters long"
    }
}
...
function checkpassword(password)
{
    if(password.length > 7 && password.includes('.'))
    {
        ...
        document.getElementById('password_error').innerText="Password must be 8 letters ling and must include '.'"
    }
}
